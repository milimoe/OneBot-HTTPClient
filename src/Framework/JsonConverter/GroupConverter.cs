...
namespace Milimoe.OneBot.Framework.JsonConverter
{
    public class GroupConverter : BaseEntityConverter<Group>
    {
        ...
        public override void ReadPropertyName(ref Utf8JsonReader reader, string propertyName, JsonSerializerOptions options, ref Group result, Dictionary<string, object> convertingContext)
        {
            switch (propertyName)
            {
                case "group_id":
